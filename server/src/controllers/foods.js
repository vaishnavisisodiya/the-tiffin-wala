...
exports.deleteFood = async(req,res) =>{
    try {
        ...
        if(!foodie || !foodie.provider.equals(req.provider._id)){
         
            return res.status(404).json({message:"Invalid Request",id:foodie,food:foodie.provider,reqq:req.provider._id})
        }
