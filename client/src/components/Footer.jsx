    ...
    <footer>
      <div className="py-4 bg-slate-800 sm:grid text-white sm:grid-cols-2 sm:px-4 md:grid md:grid-cols-3 px-5 lg:grid lg:grid-cols-3 mt-2">
        <div className="naem order-1 pt-5 md:pl-7 lg:flex flex-col items-center ">
          <h1 className='font-bold text-3xl  md:text-4xl md:pt-1'>The Tiffin Wala</h1>
      ...
      <div className=" py-4 bg-slate-700 text-white">
        <p className='text-normal text-center font-medium sm:text-lg sm:font-serif'>© Copyright 2024-2025 www.TiffinWala.com All rights reserved. Developed by Vaishnavi Sisodiya And Komal Shrivastav</p>
      </div>
